      ...
      <div class="container">
        <div class="st-main-header-in">
          <div class="st-main-header-left">
            <a class="st-site-branding" href="index.html"><img src="{{asset('assets/img/logo/logo.png')}}" alt="Davis"></a>
          </div>
          <div class="st-main-header-right">
            <div class="st-nav">
              <ul class="st-nav-list st-onepage-nav">
                ...
                <li><a href="#skills" class="st-smooth-move">Skills</a></li>
              ...
              <div class="sp-phone">
                ...
                <div class="sp-phone-no">+971- 55 996 8603</div>
              </div>
            </div>
          </div>
        </div>
