<div>
  ...
  <section id="services" class="st-dark-bg">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="st-iconbox st-style1">
            ...
            <div class="st-iconbox-text">I am having a 4+ years of experience in website development in laravel</div>
          </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="st-iconbox st-style1">
            ...
            <h2 class="st-iconbox-title">Web application development</h2>
            <div class="st-iconbox-text">I am having a strong experience in frontend and backend to create a web application and cms</div>
          </div>
          <div class="st-height-b30 st-height-lg-b30"></div>
        </div><!-- .col -->
        <div class="col-lg-4 col-md-6">
          <div class="st-iconbox st-style1">
            ...
            <h2 class="st-iconbox-title">Digital marketing</h2>
            <div class="st-iconbox-text">Having a knowledge in socialmedia management and lead genration and also having knowledge in posting ads</div>
          </div>
          <div class="st-height-b30 st-height-lg-b30"></div>
        </div><!-- .col -->
        {{-- <div class="col-lg-4 col-md-6">
