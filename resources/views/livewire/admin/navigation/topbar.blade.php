            ...
            <div class="d-flex align-items-center gap-lg-2 gap-1">
                ...
                <div class="logo-topbar">
                    ...
                    <a href="index.html" class="logo-light">
                        ...
                        <span class="logo-sm">
                            <img src="{{asset('assets/img/logo/logo.png')}}" alt="small logo">
                        </span>
                    </a>
                    ...
                    <a href="index.html" class="logo-dark">
                        <span class="logo-lg">
                            <img src="{{asset('assets/img/logo/logo@.png')}}" alt="dark logo">
                        </span>
                        <span class="logo-sm">
                            <img src="{{asset('assets/img/logo/logo@.png')}}" alt="small logo">
                        </span>
                ...
                {{-- <div class="app-search dropdown d-none d-lg-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-animated dropdown-lg" id="search-dropdown">
                        ...
                        <div class="notification-list">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <div class="d-flex">
                                    <img class="d-flex me-2 rounded-circle" src="{{asset('assets/admin/images/users/avatar-2.jpg')}}" alt="Generic placeholder image" height="32">
                                    <div class="w-100">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <div class="d-flex">
                                    <img class="d-flex me-2 rounded-circle" src="{{asset('assets/admin/images/users/avatar-5.jpg')}}" alt="Generic placeholder image" height="32">
                                    <div class="w-100">
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg p-0">
                        ...
                        <div class="p-2">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="{{asset('assets/admin/images/brands/behance.png')}}" alt="Behance">
                                        <span>Behance</span>
                                    </a>
                                </div>
                            </div> <!-- end row-->
                ...
                <li class="dropdown me-md-2">
                    <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                        <span class="account-user-avatar">
                            <img src="{{asset($profilePic)}}" alt="user-image" width="32" class="rounded-circle">
                        </span>
